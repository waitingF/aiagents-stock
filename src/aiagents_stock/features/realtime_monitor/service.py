...
from src.aiagents_stock.integrations.trading.miniqmt import miniqmt, get_miniqmt_status
from src.aiagents_stock.integrations.notification.service import notification_service

# 导入TDX数据源（如果可用）
try:
    from src.aiagents_stock.features.smart_monitor.tdx_data import SmartMonitorTDXDataFetcher
    TDX_AVAILABLE = True
except ImportError:
    TDX_AVAILABLE = False
...
class StockMonitorService:
    ...
    def get_scheduler(self):
        """获取调度器实例"""
        from src.aiagents_stock.features.realtime_monitor.scheduler import get_scheduler
