...
from src.aiagents_stock.features.selectors.low_price_bull.strategy import LowPriceBullStrategy
from src.aiagents_stock.integrations.notification.service import notification_service
from src.aiagents_stock.features.selectors.low_price_bull.monitor import low_price_bull_monitor
from src.aiagents_stock.features.selectors.low_price_bull.service import low_price_bull_service
...
def display_low_price_bull():
    ...
    if st.session_state.get('show_low_price_monitor'):
        from src.aiagents_stock.features.selectors.low_price_bull.monitor_ui import display_monitor_panel
...
def display_stock_detail(row: pd.Series):
    ...
    from src.aiagents_stock.features.selectors.low_price_bull.monitor_ui import add_stock_to_monitor_button
