...
from src.aiagents_stock.features.selectors.main_force.report import display_report_download_section
from src.aiagents_stock.features.selectors.main_force.history_ui import display_batch_history
import pandas as pd
...
def run_main_force_batch_analysis():
    ...
    if start_analysis:
        ...
        save_error = None
        try:
            from src.aiagents_stock.features.selectors.main_force.batch_repository import batch_db
