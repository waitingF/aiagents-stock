...
from src.aiagents_stock.features.smart_monitor.agents import SmartMonitorDeepSeek
from src.aiagents_stock.features.smart_monitor.data import SmartMonitorDataFetcher
from src.aiagents_stock.features.smart_monitor.qmt import SmartMonitorQMT, SmartMonitorQMTSimulator
from src.aiagents_stock.features.smart_monitor.repository import SmartMonitorDB
from src.aiagents_stock.integrations.notification.service import notification_service  # 复用主程序的通知服务
from src.aiagents_stock.app.pages.settings import config_manager  # 复用主程序的配置管理器
