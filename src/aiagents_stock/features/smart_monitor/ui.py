...
from src.aiagents_stock.app.pages.settings import config_manager  # 使用主程序的配置管理器
...
def smart_monitor_ui():
    ...
    st.caption("参照AlphaArena项目，基于AI的A股自动化交易系统")
...
def _render_task_kline_and_decisions(task: Dict, db: SmartMonitorDB, engine):
    ...
    Args:
        ...
        engine: 监控引擎实例
    """
    from src.aiagents_stock.features.smart_monitor.kline import SmartMonitorKline
    from src.aiagents_stock.features.smart_monitor.data import SmartMonitorDataFetcher
